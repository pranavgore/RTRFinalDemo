...
namespace ModelLoad
{
	...
	public:
		...
		void InitShaders()
		{
			...
			{
				vertShaderPath = "Resources/Shaders/ModelLoadingWithoutAnimation.vert.glsl";
				fragShaderPath = "Resources/Shaders/ModelLoadingWithoutAnimation.frag.glsl";

				vertShaderPathNight = "Resources/Shaders/ModelLoadingWithoutAnimationNight.vert.glsl";
				fragShaderPathNight = "Resources/Shaders/ModelLoadingWithoutAnimationNight.frag.glsl";
			}
		...
		void Draw(double tDelta)
		{
			...
			{
				this->meshes[i].Draw(m_glProgram);
			}
		}

		void DrawNight(double tDelta)
		{
			if (m_bAnimationPresent)
			{
				/*static int writeCnt = 0;
			...
			for (GLuint i = 0; i < this->meshes.size(); i++)
			{
				this->meshes[i].Draw(m_glProgramNight);
			}
		}
